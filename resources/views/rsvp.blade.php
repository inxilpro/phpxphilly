...
<div class="flex w-full flex-col justify-between bg-dots">
	<div class="w-full max-w-4xl mx-auto flex items-center gap-4 p-4">
		<x-phpx-dropdown />
		<div class="text-white/50 font-semibold hidden sm:block">A meetup for web artisans</div>
	</div>
	<div class="w-full max-w-4xl mx-auto flex flex-col items-start justify-center px-4 gap-4 py-24">
		<div class="font-mono font-semibold text-white text-4xl sm:text-6xl md:text-7xl lg:text-8xl">
			PHP×<span x-data x-typed="['Philly']"></span>
		</div>
		<div class="font-semibold">
			A bi-monthly<span x-data x-typed.cursorless.delay.2500="['(ish)']"></span> meetup for PHP artisans.
		</div>
		<div class="flex gap-4 items-center">
			<button class="bg-white px-4 py-2.5 text-black font-semibold text-lg transform opacity-90 hover:opacity-100 hover:-rotate-2">
				RSVP<span class="not-sr-only">_</span>
			</button>
			<span class="w-2"></span>
			<a href="https://www.meetup.com/php-philly/" class="group relative" target="_blank">
				<div class="absolute bg-white px-2 py-1 text-black font-mono font-bold -top-full -left-2 transform transition hidden opacity-0 group-hover:-rotate-3 group-hover:block group-hover:opacity-100">
					Meetup.com
				</div>
	...
	<div class="w-full bg-white text-black border-2 border-black font-semibold">
		<div class="w-full max-w-4xl mx-auto flex items-center gap-2 p-4 text-center justify-center xl:text-xl">
